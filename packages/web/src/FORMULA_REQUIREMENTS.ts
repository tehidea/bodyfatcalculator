export const FORMULA_REQUIREMENTS = {
  ymca: {
    name: 'YMCA',
    description:
      'A simple method that uses your weight and waist size to estimate body fat',
    fields: [
  ...
  jack3: {
    ...
    description:
      'A quick but accurate method using your age and three key skinfold measurements',
    fields: [
      { key: 'age', label: 'Age', unit: 'years', required: true },
      {
        key: 'chestSkinfold',
  ...
  jack7: {
    ...
    description:
      'The most thorough method using your age and seven different skinfold sites',
    fields: [
      { key: 'age', label: 'Age', unit: 'years', required: true },
      {
        key: 'chestSkinfold',
  ...
  parrillo: {
    ...
    fields: [
      ...
      {
        key: 'lowerBackSkinfold',
        label: 'Lower Back Skinfold',
        unit: 'mm',
        required: true,
      },
      {
