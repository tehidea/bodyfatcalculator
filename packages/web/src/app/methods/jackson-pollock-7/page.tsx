        ...
        <div className="mx-auto max-w-5xl">
          ...
          >
            ...
            <p className="mt-4 text-base text-gray-400">
              A comprehensive skinfold-based method using seven measurement sites for a more
              detailed assessment. Commonly used in field assessments.
            </p>
          </motion.div>
            ...
            >
              ...
              <div className="mt-6">
                <p className="text-gray-300">
                  Developed by Jackson and Pollock, this method represents the comprehensive
                  approach to skinfold-based body fat assessment. Uses seven strategic measurement
                  sites to account for various fat distribution patterns.
                </p>
              ...
              <div className="mt-6">
                ...
                <div className="mt-6 rounded-lg bg-black/20 p-4 text-sm text-gray-300">
                  ...
                  <ul className="mt-2 list-inside list-disc space-y-1">
                    <li>Grasp skinfolds firmly between thumb and index finger</li>
                    ...
                    <li>Take multiple measurements at each site for accuracy</li>
                  </ul>
                </div>
              </div>
            </motion.section>
