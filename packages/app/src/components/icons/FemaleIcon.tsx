...
interface FemaleIconProps extends SvgProps {
  size?: number;
  color?: string;
}

const FemaleIcon: React.FC<FemaleIconProps> = ({ size = 512, color = "black", ...props }) => (
  <Svg width={size} height={size} viewBox="0 0 361 511.42" fill={color} {...props}>
    <Path
      fillRule="nonzero"
