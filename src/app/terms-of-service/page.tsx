...
const sections = [
  ...
  },
  {
    ...
    content: (
      <p className="mt-4">
        The App is not a substitute for professional medical advice, diagnosis,
        or treatment. Always seek professional medical advice before making
  ...
  },
  {
    ...
    content: (
      <p className="mt-4">
        ...
        by Tehidea Ltd and are protected by international copyright, trademark,
  ...
  },
  {
    ...
    content: (
      <p className="mt-4">
        Your use of the App and any data you provide is subject to our Privacy
  ...
  },
  {
    ...
    content: (
      <p className="mt-4">
        To the maximum extent permitted by law, Tehidea Ltd shall not be liable
