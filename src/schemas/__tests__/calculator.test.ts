...
describe("Calculator Schemas", () => {
  describe("Weight Schema", () => {
    test("validates metric weight correctly", () => {
      ...
      // Invalid weights
      expect(() => schema.parse({ weight: 19, waistCircumference: 85 }))
        .toThrow("Weight must be at least 20 kg");
      expect(() => schema.parse({ weight: 301, waistCircumference: 85 }))
        .toThrow("Weight cannot exceed 300 kg");
    });
    ...
    test("validates imperial weight correctly", () => {
      ...
      // Invalid weights
      expect(() => schema.parse({ weight: 43, waistCircumference: 33.5 }))
        .toThrow("Weight must be at least 44 lbs");
      expect(() => schema.parse({ weight: 662, waistCircumference: 33.5 }))
        .toThrow("Weight cannot exceed 661 lbs");
    });
  });
  ...
  describe("Circumference Schema", () => {
    test("validates metric circumference correctly", () => {
      ...
      expect(() => schema.parse({ weight: 80, waistCircumference: 0.9 }))
        .toThrow("Circumference must be at least 1 cm");
      expect(() => schema.parse({ weight: 80, waistCircumference: 201 }))
        .toThrow("Circumference cannot exceed 200 cm");
    });
    ...
    test("validates imperial circumference correctly", () => {
      ...
      // Invalid circumferences
      expect(() => schema.parse({ weight: 176, waistCircumference: 0.3 }))
        .toThrow("Circumference must be at least 0.4 in");
      expect(() => schema.parse({ weight: 176, waistCircumference: 78.8 }))
        .toThrow("Circumference cannot exceed 78.7 in");
    });
  });
  ...
  describe("Gender-specific schemas", () => {
    test("validates female-specific fields in metric", () => {
      ...
      // Invalid wrist circumference
      expect(() => schema.parse({
        weight: 60,
        waistCircumference: 70,
        wristCircumference: 51,
        hipsCircumference: 90,
        forearmCircumference: 25
      })).toThrow("Wrist circumference cannot exceed 50 cm");
    });
    ...
    test("validates female-specific fields in imperial", () => {
      ...
      expect(() => schema.parse({
        weight: 132,
        waistCircumference: 27.6,
        wristCircumference: 19.8,
        hipsCircumference: 35.4,
        forearmCircumference: 9.8
      })).toThrow("Wrist circumference cannot exceed 19.7 in");
    });
