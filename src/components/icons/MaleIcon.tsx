...
interface MaleIconProps extends SvgProps {
  size?: number;
  color?: string;
}

const MaleIcon: React.FC<MaleIconProps> = ({ size = 512, color = "black", ...props }) => (
  <Svg width={size} height={size} viewBox="0 0 512 511.01" fill={color} {...props}>
    <Path
      fillRule="nonzero"
