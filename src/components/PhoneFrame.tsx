  ...
  return (
    ...
    >
      ...
      <rect
        ...
        height="5"
        rx="2.5"
        fill={variant === 'light' ? '#D4D4D4' : '#404040'}
      />
    </svg>
  )
}
...
export function PhoneFrame({
  ...
  return (
    <div className={clsx('relative aspect-[366/729]', className)} {...props}>
      <div
        className={clsx(
          'absolute inset-y-[calc(1/729*100%)] left-[calc(7/729*100%)] right-[calc(5/729*100%)] rounded-[calc(58/366*100%)/calc(58/729*100%)]',
          variant === 'dark' ? 'shadow-2xl shadow-gray-900' : 'shadow-2xl',
        )}
      />
      <div
        className={clsx(
          'absolute left-[calc(23/366*100%)] top-[calc(23/729*100%)] grid h-[calc(686/729*100%)] w-[calc(318/366*100%)] transform grid-cols-1 overflow-hidden pt-[calc(23/318*100%)]',
      ...
      <PlaceholderFrame
        className={clsx(
          ...
          variant === 'dark' ? 'fill-gray-800' : 'fill-gray-100',
        )}
        variant={variant}
      />
      <Image
